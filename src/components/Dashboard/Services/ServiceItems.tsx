...
const ServiceItem: React.FC<ServiceItemProps> = ({
  ...
  return (
    ...
    >
      <Card
        className={`w-full h-full border-[#1e293b] bg-[#0f172a] hover:border-[#1B89A4]/50 transition-all duration-300 overflow-hidden ${comingSoon ? "opacity-70 cursor-not-allowed" : ""}`}
      >
        <CardContent className="p-5 flex flex-col items-center text-center">
          ...
          <div className="relative z-10 mb-3 h-14 w-14 rounded-xl bg-[#1e293b] flex items-center justify-center group-hover:bg-[#1B89A4]/20 transition-all duration-300">
