...
const DataModal = ({ onClose, onShowPayment, state, onStateChange }: DataModalProps) => {
  ...
  useEffect(() => {
    ...
    fetchBillers();
  }, [getBillersByCategory]); // Added missing dependency
  ...
  useEffect(() => {
    ...
    fetchBillItems();
  }, [state.selectedNetwork, billers, getBillItems]); // Added missing dependency
  ...
  }, [state.billPlan, billItems, onStateChange, state]); // Added missing dependencies
