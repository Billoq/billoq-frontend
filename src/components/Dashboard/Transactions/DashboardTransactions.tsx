      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        <div className="relative w-full">
          ...
          <Input
            ...
            className="w-full pl-10 pr-4 py-2 bg-[#1e293b] border border-[#2e3b52] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:border-transparent transition-all"
                      value={searchQuery}
...
const TransactionTable = ({
  ...
  return (
    <div className="relative flex-1 min-h-0 overflow-x-hidden hover:overflow-x-visible overflow-y-auto border border-[#1E293B] rounded-lg bg-transparent table-container shadow-xl shadow-blue-900/5 transition-all duration-300">
      {contextLoading && (
