...
const ServiceCard: React.FC<{
  ...
  return (
    <div
  className="rounded-lg p-5 h-[320px] max-w-6xl flex flex-col"
  style={{
    backgroundImage: `
...
>
  ...
  <button className="mt-auto bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-md text-sm font-medium transition-colors">
    Pay Now
  </button>
</div>
